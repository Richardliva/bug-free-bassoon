...
import 'package:petrol_app_mtaani_tech/screens/fueling/continue_fuel.dart';
...
class AdminFuel extends StatefulWidget {
  final LiveStatsModel liveStats;
  const AdminFuel({super.key, required this.liveStats});

  @override
  State<AdminFuel> createState() => _AdminFuelState();
}

class _AdminFuelState extends State<AdminFuel> {
    ...
    return FutureBuilder<List<FuelingModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasData && snapshot.data!.isNotEmpty) {
            ...
            // odometerInKms.text = lastOdometer;
  ...
  void fuelVehicle(
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ContinueFuel(
                  vehicle: vehicleModel,
                  owner: ownerModel,
                  fueling: fuelingModel,
                  livestats: widget.liveStats,
                  user: userModel,
